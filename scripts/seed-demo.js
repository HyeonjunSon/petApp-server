...
const PEOPLE = [
  { name: "Seojun Kim", gender: "male",   region: "Seoul · Mapo", birthYear: 1994, goal: "both",
    ...
    pet: { name: "Choco", breed: "Pomeranian", age: 3, sex: "male",   size: "s", temperament: ["Energetic", "Friendly"], about: "An energetic Pomeranian looking for a playmate to run around with!" } },
  { name: "Jiwoo Lee", gender: "female", region: "Seoul · Gangnam", birthYear: 1996, goal: "friends",
    ...
    pet: { name: "Mong", breed: "Maltese", age: 2, sex: "female", size: "s", temperament: ["Gentle", "Shy"], about: "Shy at first, but a total sweetheart once we're friends." } },
  { name: "Minjun Park", gender: "male",   region: "Seoul · Seongdong", birthYear: 1992, goal: "dating",
    ...
    pet: { name: "Max", breed: "Golden Retriever", age: 3, sex: "male", size: "l", temperament: ["Energetic", "Friendly"], about: "A golden who truly loves people. Two walks a day!" } },
  { name: "Sua Choi", gender: "female", region: "Seoul · Songpa", birthYear: 1998, goal: "both",
    ...
    pet: { name: "Dubu", breed: "Bichon Frise", age: 4, sex: "male", size: "s", temperament: ["Gentle", "Friendly"], about: "A cloud-like Bichon. Very social with lots of friends." } },
  { name: "Haneul Jung", gender: "male",   region: "Seoul · Eunpyeong", birthYear: 1995, goal: "friends",
    ...
    pet: { name: "Haru", breed: "Shiba Inu", age: 5, sex: "male", size: "m", temperament: ["Independent", "Energetic"], about: "A proud Shiba who genuinely loves walks." } },
  { name: "Yeeun Kang", gender: "female", region: "Seoul · Seocho", birthYear: 1997, goal: "dating",
    ...
    pet: { name: "Bori", breed: "Welsh Corgi", age: 2, sex: "female", size: "m", temperament: ["Energetic", "Friendly"], about: "A corgi working hard on those short little legs!" } },
  { name: "Dohyun Yoon", gender: "male",   region: "Seoul · Yongsan", birthYear: 1993, goal: "both",
    ...
    pet: { name: "Kong", breed: "Beagle", age: 3, sex: "male", size: "m", temperament: ["Energetic", "Shy"], about: "A beagle whose favorite thing in the world is sniffing." } },
  { name: "Chaewon Lim", gender: "female", region: "Seoul · Jongno", birthYear: 1999, goal: "friends",
    ...
    pet: { name: "Luna", breed: "Pomeranian", age: 1, sex: "female", size: "s", temperament: ["Energetic", "Friendly"], about: "Still a baby, so full of curiosity." } },
  { name: "Jiho Han", gender: "male",   region: "Seoul · Gwangjin", birthYear: 1991, goal: "dating",
    ...
    pet: { name: "Mungchi", breed: "Jindo", age: 6, sex: "male", size: "l", temperament: ["Gentle", "Independent"], about: "A sturdy, calm Jindo." } },
  { name: "Seoyeon Oh", gender: "female", region: "Seoul · Dongjak", birthYear: 2000, goal: "both",
    ...
    pet: { name: "Coco", breed: "Shih Tzu", age: 4, sex: "female", size: "s", temperament: ["Gentle", "Friendly"], about: "A laid-back, affectionate Shih Tzu." } },
];
