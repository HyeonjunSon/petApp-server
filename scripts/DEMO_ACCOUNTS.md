...
- **Chat**: existing conversation with Mong (demo2)
- **Walk plans**: confirmed with demo2, proposed to demo3
- **Walk records**: 3 walks for Choco

> Photos: owner faces from randomuser.me, pets from placedog.net (public images). If an image fails to load, the app falls back to a placeholder automatically.
